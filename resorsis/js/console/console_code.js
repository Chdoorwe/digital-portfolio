...
// Custom Commands
// ===============================
function addAliases(names, handler, options = {}) {
  names.forEach(n => addCommand(n, handler, options));
}
...
addCommand("run:/fuc-HelloThere", async () => {
  crtFlicker();
  await typeLine("hello there scribe 4-Δ i now you have been adding thes to are frinds stuff but i must change the topic like your document 'The Huntsman' says about me in fare and im on YOUR side. i also now and about the Primary Authority and i have seen it. also my true name is Chdoorwe Hellsin");
}, { hidden: false });
